...
void SendMessage(String data)
{
  ...
  delay(1000);
  //String ss = "HI!!!!!!!!";
  //mySerial.println("HII!!");// The SMS text you want to send
...
void SendMessage1(String data)
{
    mySerial.println("AT+CMGF=1");    //Sets the GSM Module in Text Mode
    delay(1000);  // Delay of 1000 milli seconds or 1 second
    mySerial.println("AT+CMGS=\"+09750212500\"\r"); // Replace x with mobile number
    delay(1000);
    //String ss = "HELLO!!";
    //mySerial.println(ss);// The SMS text you want to send
    mySerial.println(data);// The SMS text you want to send
    delay(100);
    mySerial.println((char)26);// ASCII code of CTRL+Z
    delay(1000);
